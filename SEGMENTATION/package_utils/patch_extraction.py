...
def patch_extraction_wall(img: np.ndarray,
    ...
    if resize_col == True:
        ...
        scale = (spatial_res_y ) / desired_spatial_res * 1e6
    ...
    if (right_border - left_border) >= width_window:
        ...
        while condition:
            ...
            # print('------------------------')
            # print(name_seq)
            # print(f'patch_m_center shape    : {patch_m_center.shape} \n')
            # print(f'patch_m_bottom shape    : {patch_m_bottom.shape} \n')
            # print(f'patch_m_top shape       : {patch_m_top.shape} \n')
            # print(f'patch_img_center shape  : {patch_img_center.shape} \n')
            # print(f'patch_img_bottom shape  : {patch_img_bottom.shape} \n')
            # print(f'patch_img_top shape     : {patch_img_top.shape} \n')
            # print('------------------------')
            # print('------------------------')
            #
            # # mask
            ...
            if patch_m_center.shape == (512,128) and patch_img_center.shape == (512,128):
                ...
                img_nb += 1  # since three patches are extracted
            if patch_m_bottom.shape == (512,128) and patch_img_bottom.shape == (512,128):
