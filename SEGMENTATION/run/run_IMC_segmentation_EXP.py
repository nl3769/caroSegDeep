...
if __name__ == '__main__':
    ...
    patient_name_list = ['tech_268.tiff']
    ...
    for patientName in patient_name_list:
        ...
        # --- compute metrics
        MAE_IMT_, MAE_LI_, MAE_MA_ = compute_metrics_IMC(p.PATH_TO_CONTOURS[:-3], patientName, 'A1', seq.annotationClass.map_annotation[1,] / seq.scale, p)
