...
def setParameters():
  ...
  p = Parameters(
    ...
    PATH_TO_SAVE_DATASET='/run/media/laine/HDD/PROJECTS_IO/caroSegDeep/DATASET',           # path to save the dataset in h5 format
    PATH_TO_SKIPPED_SEQUENCES='/run/media/laine/HDD/PROJECTS_IO/caroSegDeep/DATASET',      # If an image can't be part of the sets then it saves in .txt file
    PATH_TO_FOLDS='/home/laine/cluster/PROJECTS_IO/DATA/MEIBURGER/Folds',     # In this directory .txt files contain the patient's name according to their belonging (train/val/test)
