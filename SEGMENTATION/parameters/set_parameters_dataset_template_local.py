...
def setParameters():
  ...
  p = Parameters(
    ...
    PATH_TO_BORDERS='/home/laine/cluster/PROJECTS_IO/DATA/MEIBURGER/PREPROCESSED_DATA/REFERENCES/BORDERS/BORDERS_A1',   # Path where the borders are saved (.mat)
    PATH_TO_CONTOUR='/home/laine/cluster/PROJECTS_IO/DATA/MEIBURGER/PREPROCESSED_DATA/REFERENCES/CONTOURS/A1',          # Path where the contours are saved (.mat, .txt)
    ...
    PATH_TO_SAVE_DATASET='/home/laine/Desktop',#'/run/media/laine/HDD/PROJECTS_IO/caroSegDeep/DATASET',                                        # path to save the dataset in h5 format
    PATH_TO_SKIPPED_SEQUENCES='/home/laine/cluster/PROJECTS_IO/DATA/MEIBURGER/PREPROCESSED_DATA/DATASET',               # If an image can't be part of the sets then it saves in .txt file
